...
public class CovidChart extends Application {
    ...
    private BorderPane mainLayout;  // Tambahkan deklarasi mainLayout
    private StackPane mapContainer; // Tambahkan reference ke mapContainer

    // Data untuk slider vaksinasi
    ...
    public void start(Stage stage) {
        ...
        mainLayout = new BorderPane();  // Inisialisasi mainLayout
    ...
    private VBox createHeader() {
        ...
        // Tanggal update
        Label updateLabel = new Label("Terakhir diupdate : 30/03/2020 15:35");
        ...
        topRow.getChildren().addAll(title, spacer, updateLabel);
    ...
    private HBox createStatCards() {
        ...
        createStatCard(stats, "Terkonfirmasi", "1,135", "+153 Kasus", DANGER);
        createStatCard(stats, "Dalam Perawatan", "951", "87.3% dari terkonfirmasi", WARNING);
        createStatCard(stats, "Sembuh", "86", "5.6% dari terkonfirmasi", SUCCESS);
        createStatCard(stats, "Meninggal", "78", "8.1% dari terkonfirmasi", INFO);
    ...
    private VBox createMapSection() {
        ...
        mapContainer = new StackPane(); // Gunakan field class
        mapContainer.setId("mapContainer");  // Tambahkan ID untuk referensi
        ...
        try {
            ...
            addRegionTooltip(mapView, "DKI Jakarta: 598 Kasus", DANGER);
    ...
    private VBox createProvinceTable() {
        ...
        // Data provinsi
        addProvinceRow(provinceList, "DKI Jakarta", "598", true);
        addProvinceRow(provinceList, "Jawa Barat", "98", true);
        addProvinceRow(provinceList, "Banten", "84", false);
        addProvinceRow(provinceList, "Jawa Timur", "66", true);
        addProvinceRow(provinceList, "Jawa Tengah", "43", true);
        addProvinceRow(provinceList, "Sulawesi Selatan", "29", true);
        addProvinceRow(provinceList, "D.I. Yogyakarta", "22", false);
        addProvinceRow(provinceList, "Kalimantan Timur", "11", true);
